...
class SpartanColors {
  ...
  static const SpartanColor turquoise = SpartanColor (_turquoisePrimaryValue, <String, Color>{
  ...
  /// gold and swatches
  static const SpartanColor gold = SpartanColor (_goldPrimaryValue, <String, Color>{
  ...
  /// ice and swatches
  static const SpartanColor ice = SpartanColor (_icePrimaryValue, <String, Color>{
    'base': Color(0xFFF2F5F7),
  });
  static const int _icePrimaryValue = 0xFFF2F5F7;

  /// green and swatches
  static const SpartanColor green = SpartanColor (_greenPrimaryValue, <String, Color>{
  ...
  static const SpartanColor magenta = SpartanColor (_magentaPrimaryValue, <String, Color>{
  ...
  /// night and swatches
  static const SpartanColor night = SpartanColor (_nightPrimaryValue, <String, Color>{
  ...
  /// blue and swatches
  static const SpartanColor blue = SpartanColor (_bluePrimaryValue, <String, Color>{
  ...
  /// grey and swatches
  static const SpartanColor grey = SpartanColor (_greyPrimaryValue, <String, Color>{
  ...
  /// red and swatches
  static const SpartanColor red = SpartanColor (_redPrimaryValue, <String, Color>{
  ...
  /// white and swatches
  static const SpartanColor white = SpartanColor (_whitePrimaryValue, <String, Color>{
